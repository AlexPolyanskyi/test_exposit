 ...
 */
public class FiveDaysFragmentAdapter extends RecyclerView.Adapter<FiveDaysFragmentAdapter.MyViewHolder> {
    ...
    public FiveDaysFragmentAdapter(Activity activity, List<? extends Weather> data, View view) {
    ...
    @Override
    public FiveDaysFragmentAdapter.MyViewHolder onCreateViewHolder(ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(FiveDaysFragmentAdapter.MyViewHolder holder, int position) {
        FiveDaysWeather weather = (FiveDaysWeather) data.get(position);
